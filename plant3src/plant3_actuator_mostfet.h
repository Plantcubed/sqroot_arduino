...
#ifndef ACTUATOR_MOSFET_H
#define ACTUATOR_MOSFET_H
 ...
 * \brief Actuator module for an active low SPST-NO relay.
 */
class Plant3_ActuatorMosFET : SensorActuatorModule {
  //------------------------------------------------PUBLIC---------------------------------------------//
  public:
    /* Public Functions */
    /**
     ...
     * 1 and 2.
     */
	  Plant3_ActuatorMosFET(int pin, String instruction_code, int instruction_id);
