...
#ifndef ACTUATOR_HEATER_H
#define ACTUATOR_HEATER_H
 ...
 * \brief Actuator module for an active low SPST-NO relay.
 */
class Plant3_ActuatorHeater : SensorActuatorModule {
  //------------------------------------------------PUBLIC---------------------------------------------//
  public:
    /* Public Functions */
    /**
     ...
     * 1 and 2.
     */
	  Plant3_ActuatorHeater(String instruction_code, int instruction_id, int heater_pin, int fan_pin);
